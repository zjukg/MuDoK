...
def get_args():
    ...
    parser.add_argument('--base_path', default='../save/Amazon-LR0.0003-MU0.01-Temp0.1', type=str)
...
if __name__ == "__main__":
    ...
    model = GPTKGPrompt(args.model_path, args.base_path, args.checkpoint, args.prompt_map_path).cuda()
